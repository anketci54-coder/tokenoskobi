...
```text
README.md=single_entry_boot_pointer
PROJECT_RUNTIME.json=runtime_state
PROJECT_BOOT.json=stable_boot_contract
...
data/tokenoskobi_v1_v8_master_era_roadmap.json=detailed_roadmap
```
...
```text
README=SINGLE_ENTRY_BOOT_POINTER_ONLY
INDEX=NAVIGATION_ONLY
MANIFESTO=COMPLETE_CONSTITUTION_DOCTRINE_ONLY
...
Current-state data must not be copied into Index, Manifesto, Roadmap,
Atlas or legacy compatibility pointers.
