...
LAST_COMPLETED_SUBSTEP=ERA56H_GLOBAL_CACHE_SINGLE_CYCLE_CANARY_APPLY_AND_POSTCHECK
...
LAST_ARTIFACT=data/control/era56h_global_cache_single_cycle_canary_apply_and_postcheck_v1.json
...
Review canary evidence and decide whether any future runtime binding is justified. No automatic promotion.
