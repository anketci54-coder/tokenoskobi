...
LAST_COMPLETED_SUBSTEP=ERA56D_GLOBAL_CACHE_ATOMIC_PUBLISH_AND_READONLY_CONSUMER_DRYRUN
...
LAST_ARTIFACT=data/control/era56d_global_cache_atomic_publish_and_readonly_consumer_dryrun_v1.json
...
Decide whether a bounded runtime binding test is justified. No production binding is authorized by ERA56D.
