...
```text
LAST_COMPLETED=PRE_ERA57_REPO_AND_PIPELINE_HYGIENE_CLOSURE
LAST_RESULT=OK_PRE_ERA57_REPO_AND_PIPELINE_HYGIENE_CLOSED
LAST_ARTIFACT=data/control/pre_era57_repo_pipeline_hygiene_closure_v1.json
