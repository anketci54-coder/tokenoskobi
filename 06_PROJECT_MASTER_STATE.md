...
LAST_COMPLETED_SUBSTEP=ERA56B_GLOBAL_CACHE_READONLY_SCHEMA_AND_TEMP_COPY_BUILD
...
LAST_ARTIFACT=data/control/era56b_global_cache_readonly_schema_and_temp_copy_build_v1.json
...
Define actual record mapping into the isolated cache and prove logical parity without production binding.
