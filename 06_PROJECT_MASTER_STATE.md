...
```text
LAST_COMPLETED=PRE_ERA57_RAW_RUNNER_BOUNDED_PATH_REPAIR_DECISION
LAST_RESULT=OK_EXACT_HISTORY_BLOB_VALIDATED
LAST_ARTIFACT=data/control/pre_era57_raw_runner_bounded_path_repair_decision_v1.json
DECISION=AUTHORIZE_EXACT_GIT_HISTORY_RESTORE_REVIEW
HISTORY_BLOB_FOUND=true
...
NEXT_SAFE_STEP=PRE_ERA57_RAW_RUNNER_EXACT_RESTORE_AND_NATURAL_CYCLE_VERIFY
...
Follow the bounded raw-runner decision. No unrelated runtime changes.
