...
The reusable writer now accounts for every real display candidate on a disposable DB copy and reproduces the current gateway queue exactly. Production binding remains blocked.
