...
## Audit Required Terms Repair Block

Bu bölüm `UI_CENTER_SUBPANELS_MAP_POST_AUDIT_NOAPI` sonrası birebir doküman terimi doğrulaması için eklenmiştir. Yapısal harita değişmemiştir.

- Paper Trade ayrı ana merkez değil
- Paper Trade özeti Komuta Merkezi altında
- Paper Trade risk kontrolü Risk Güvenlik Merkezi altında
- Paper Simülasyon Motoru Sistem Kontrol Merkezi altında
- AI Kalibrasyon Sistem Kontrol Merkezi altında
- Outcome Memory Sistem Kontrol Merkezi altında
- Komuta Merkezi sadece Paper/AI özetini gösterir
- Yaşam Destek Merkezi
- Sistem Kontrol Merkezi
...
- Preview üretilmedi.
- Asset değişmedi.
- 8 ana merkez sabit kaldı.
- Paper Trade ve AI Kalibrasyon ayrı ana merkez yapılmadı.
- Sadece doküman doğrulama terimleri eklendi.

Repair phase: `UI_CENTER_SUBPANELS_MAP_DOC_TERM_REPAIR_POST_AUDIT_NOAPI`  
Repair timestamp: `20260517_222053`
