...
STATUS=BLOCKED_PENDING_SERVER_REDEPLOY_AND_AUTHENTICATED_HUMAN_PHONE_ACCEPTANCE
NEXT_SAFE_STEP=DEPLOY_SLICE04_HEALTH_LABEL_FIX_THEN_AUTHENTICATED_PHONE_ACCEPTANCE
NEXT_PLANNED_STAGE=PRODUCT_SLICE_04_AUTHENTICATED_PHONE_ACCEPTANCE
ARTIFACT=data/control/product_slice_04_production_loopback_panel_binding_v1.json
...
SLICE04_HEALTH_LABEL_FIX=PREPARED_PENDING_SERVER_REDEPLOY
