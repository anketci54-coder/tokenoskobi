...
LAST_COMPLETED_SUBSTEP=ERA56E_GLOBAL_CACHE_BOUNDED_RUNTIME_BINDING_READINESS_DECISION
...
LAST_ARTIFACT=data/control/era56e_global_cache_bounded_runtime_binding_readiness_decision_v1.json
...
- Bounded binding plan: `AUTHORIZED`.
