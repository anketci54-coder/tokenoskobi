...
LAST_COMPLETED_SUBSTEP=ERA56K_GLOBAL_CACHE_FINAL_CLOSURE_READINESS_DECISION
...
LAST_ARTIFACT=data/control/era56k_global_cache_final_closure_readiness_decision_v1.json
WORK_UNIT_STATUS=CLOSED_FINAL_CLOSURE_READY
DECISION=READY_FOR_FINAL_CLOSURE_AND_GITHUB_SEAL_DECISION
CURRENT_PROBLEM=ERA56_FINAL_CLOSURE_AND_GITHUB_SEAL_DECISION_PENDING
...
- ERA56 final closure readiness: `TRUE`.
- ERA56 closed: `FALSE`.
