...
LAST_COMPLETED_SUBSTEP=ERA56A_GLOBAL_CACHE_OWNERSHIP_OVERLAP_AND_REBUILD_CONTRACT
...
LAST_ARTIFACT=data/control/era56a_global_cache_ownership_overlap_and_rebuild_contract_v1.json
...
- ERA56 ownership contract: `LOCKED`.
