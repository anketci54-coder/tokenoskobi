...
3. Dosya Kütüphanesi veya AI hafızası canonical repository yerine kullanılmaz.
...
MASTER_ROADMAP_JSON=DETAILED_ROADMAP_AUTHORITY

Legacy `PROJECT_MASTER_STATE.md` and `PROJECT_HANDOFF.md` files are
