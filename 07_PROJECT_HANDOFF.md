...
LAST_COMPLETED_SUBSTEP=ERA56G_GLOBAL_CACHE_SINGLE_CYCLE_CANARY_APPLY_DECISION
...
LAST_ARTIFACT=data/control/era56g_global_cache_single_cycle_canary_apply_decision_v1.json
...
- Single-cycle canary apply: `AUTHORIZED`.
