...
try:
    rt = TrackedRuntime(json.loads(RUNTIME.read_text(encoding="utf-8")))
...
if last_step not in MANDATORY_SEQUENCE and last_step not in ["RUNTIME_UPDATE", "BOOT_RUNTIME_SYNC"]:
